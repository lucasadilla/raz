                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full">
                            ...
                            {item.image && (
                                <div className="aspect-ratio-container">
                                    <img src={item.image} alt={item.title} className="aspect-ratio-image-small" />
                                </div>
                            )}
                            {item.url && !item.content ? (
                                <a href={item.url} target="_blank" rel="noreferrer noopener" className="text-blue-500 hover:underline">
                                    {item.title}
                                </a>
                            ) : (
                                item.content
